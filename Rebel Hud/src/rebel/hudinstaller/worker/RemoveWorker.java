...
public class RemoveWorker extends Worker
{
    ...
    public void process()
    {
        ...
        try
        {
            Timer.execute();                                                        // Starts the timer on a seperate thread
            ...
            JOptionPane.showMessageDialog(null, "RebelHud uninstalled successfully.", "Uninstallation Status",
        ...
        } catch(Throwable e)                        // Handles the possible errors
        {
            ...
            JOptionPane.showMessageDialog(null, "ERROR: " + e.getMessage(), "Uninstallation Error",
